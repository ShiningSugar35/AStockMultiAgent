...
11. Broad current stock-picking 继续遵守全市场 workflow：Research Team → current Universe/seeds → blind tranche → bounded Expert overlay → company Fundamental/Financial/Catalyst/Market → Valuation → independent Bull/Bear → Reviewer → Committee → Portfolio → Recommendation Gate。Universe 不可证明时 fail closed，不可用 Web/news 人工补股票名单。
