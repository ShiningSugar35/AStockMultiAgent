...
4. **Wait for real forward observations**
...
6. **Track research-production efficiency prospectively**
...
7. **Catalyst/KPI updates are local reruns**
...
8. **Admission remains separate from production mutation**
