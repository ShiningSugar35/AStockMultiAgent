CREATE TABLE zhihu_imported_response (
    ...
    transport TEXT NOT NULL CHECK (transport IN ('CHROME', 'MANUAL_IMPORT')),
    source_snapshot_id TEXT NOT NULL,
    raw_object_hash TEXT NOT NULL,
    body_byte_size INTEGER NOT NULL CHECK (body_byte_size >= 0),
    import_status TEXT NOT NULL CHECK (import_status IN ('PENDING', 'CONSUMED', 'REJECTED')),
...
ON zhihu_imported_response(source_id, import_status, response_kind, imported_at, envelope_id);
