...
def test_web_agent_product_commands_are_registered() -> None:
    ...
    assert {
        ...
        "external-account-event-append",
        "external-account-import-preview",
        "external-account-import-confirm",
        "external-account-projection",
        "external-account-audit",
        "external-account-migrate-legacy-default",
        "portfolio-complement-screen",
        "portfolio-etf-profile-register",
        "portfolio-fund-profile-register",
        "portfolio-index-profile-register",
        "portfolio-product-constituents-register",
        "portfolio-etf-nav-register",
        "portfolio-etf-market-price-register",
        "portfolio-etf-premium-discount",
